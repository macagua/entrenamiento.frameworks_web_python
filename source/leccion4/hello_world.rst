...
datos ``POST`` suministrados. Estos son los bloques de construcción muy simplificados
utilizados en marcos populares como :ref:`Flask <python_leccion6>` y
:ref:`Django <python_leccion7>`.
...
.. important::
    ...
    siguientes enlaces: :download:`wsgi_hello_world_get_request.py <../../recursos/leccion4/wsgi_hello_world_get_request.py>`
    y :download:`hello_world_post_request.py <../../recursos/leccion4/wsgi_hello_world_post_request.py>`.
