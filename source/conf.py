...
project_namecode = "entrenamiento.frameworks_web_python"
project_short_name = "frameworks de Desarrollo Web en Python - Nivel básico"
...
linkcheck_ignore = [
    ...
    r"http://localhost:8051",
    r"http://127.0.0.1:8051",
...
html_use_opensearch = "entrenamiento-frameworks-web-python.readthedocs.io"
