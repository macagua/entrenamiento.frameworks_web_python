# -*- coding: utf-8 -*-
#
# entrenamiento.frameworks_web_python documentation build configuration file, created by
...
project_namecode = u'entrenamiento.frameworks_web_python'
project_short_name = u'frameworks de Desarrollo Web en Python - Nivel básico'
project = project_short_name[0].capitalize() + project_short_name[1:38]
project_namefile = project_namecode.replace(".", "_")
...
htmlhelp_basename = '{0}doc'.format(project_namefile)
...
latex_documents = [
  (master_doc, project_namefile + ".tex", project_details, author, 'manual'),
]
...
#man_pages = [
#    (master_doc, project_namefile, project_details,
#     [author], 1)
#]
...
texinfo_documents = [
  (master_doc, project_namefile, project_details, author,
   project_namefile, project_details,
   'Miscellaneous'),
]
...
#epub_basename = project_namecode
